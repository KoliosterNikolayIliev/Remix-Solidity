...
contract TokenEcoSystemParticipation is Pausable, Ownable {
    ...
    // Constructor
    constructor(string memory _name, address _acceptedTokens, address _acceptedSenderAddress, address _poolConsumerInterfaceAddress, address _aggregatorConsumerInterfaceAddress) {
