...
// File: contracts/vesting_t_and_a_v14.sol
...
contract VestingTeamAndAdvisors is Ownable {
    ...
    */
    ...
    function getReasonForCancellation(address beneficiary_) external view returns (string[] memory){
        require(msg.sender == owner() || msg.sender == beneficiary_, "Cancellation info can be viewed only by beneficiary or contract owner!");
        uint256 counter = 0;
